...
var PanelGroup = (function (_Component) {
    ...
    function PanelGroup() {
        ...
        _get(Object.getPrototypeOf(PanelGroup.prototype), 'constructor', this).apply(this, arguments);
    }
    ...
    _createClass(PanelGroup, [{
        ...
        value: function renderChildren() {
            ...
            return _reactAddons2['default'].Children.map(this.props.children, function (child) {
                return _reactAddons2['default'].addons.cloneWithProps(child, { eventKey: ++eventKeyCount });
            });
        }
    }, {
        key: 'render',
