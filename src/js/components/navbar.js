		...
		return(
			<Navbar inverse={ false } style={ { width:"1150px",marginLeft:"20px" } } >
                    <Nav bsStyle="pills" stacked activeKey={1} onSelect={this.handleSelect}>
                        <NavItem eventKey={2} title="Front-End List" className="nav-bar-items" href="#" >
                            <span style={ {    color: 'black'} }>Front-End List</span>
                        </NavItem>
                        <NavItem eventKey={3} title="Toolkits" className="nav-bar-items" href="#" >
                            <span style={ {    color: 'black'} }>Toolkits</span>
                        </NavItem>
                        <NavItem eventKey={4} title="Frameworks" className="nav-bar-items" href="#" >
                            <span style={ {    color: 'black'} }>Frameworks</span>
                        </NavItem>
                        <NavItem eventKey={5} title="Resources" className="nav-bar-items" href="#" >
                            <span style={ {    color: 'black'} }>Resources</span>
                        </NavItem>
                        <NavItem eventKey={6} title="Learning" className="nav-bar-items" href="#" >
                        ...
                        <NavItem eventKey={8} title="Why?" href="#" style={ {    marginLeft: '525px'} }>
